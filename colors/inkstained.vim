...
hi Title ctermfg=162 ctermbg=NONE cterm=bold guifg=#b778a0 guibg=NONE gui=bold
...
hi SpecialKey ctermfg=23 ctermbg=38 cterm=bold guifg=#cbd7dc guibg=#59899c gui=bold
...
hi Number ctermfg=81 ctermbg=23 cterm=NONE guifg=#4e7e91 guibg=#cbd7dc gui=NONE
hi Identifier ctermfg=235 cterm=bold guifg=#555f6f gui=bold
hi Function ctermfg=235 cterm=bold guifg=#555f6f gui=bold
hi Statement ctermfg=68 cterm=bold guifg=#56759a gui=bold
hi Operator ctermfg=162 cterm=NONE guifg=#b778a0 gui=NONE
hi Include ctermfg=98 cterm=NONE guifg=#7c6a93 gui=NONE
hi PreProc ctermfg=183 cterm=NONE guifg=#9784ae gui=NONE
hi Type ctermfg=162 cterm=NONE guifg=#b778a0 gui=NONE
hi StorageClass ctermfg=68 cterm=bold guifg=#56759a gui=bold
hi Structure ctermfg=162 cterm=NONE guifg=#b778a0 gui=NONE
hi Typedef ctermfg=68 cterm=bold guifg=#56759a gui=bold
hi Special ctermfg=111 ctermbg=NONE cterm=bold guifg=#6b89b0 guibg=NONE gui=bold
...
hi IncSearch ctermfg=255 ctermbg=38 cterm=bold guifg=#e4e2df guibg=#59899c gui=bold
...
hi TabLineSel ctermfg=255 ctermbg=162 cterm=bold guifg=#e4e2df guibg=#b778a0 gui=bold
...
hi DiffAdd ctermfg=38 ctermbg=23 cterm=NONE guifg=#59899c guibg=#cbd7dc gui=NONE
hi DiffChange ctermfg=162 ctermbg=89 cterm=NONE guifg=#b778a0 guibg=#d9d3d6 gui=NONE
hi DiffDelete ctermfg=162 ctermbg=89 cterm=NONE guifg=#b778a0 guibg=#d9d3d6 gui=NONE
hi DiffText ctermfg=218 ctermbg=89 cterm=bold guifg=#dfb5ce guibg=#d9d3d6 gui=bold
hi diffAdded ctermfg=38 ctermbg=23 cterm=NONE guifg=#59899c guibg=#cbd7dc gui=NONE
hi diffRemoved ctermfg=162 ctermbg=89 cterm=NONE guifg=#b778a0 guibg=#d9d3d6 gui=NONE
...
hi MoreMsg ctermfg=68 cterm=NONE guifg=#56759a gui=NONE
...
hi GitGutterAdd ctermfg=38 ctermbg=241 cterm=bold guifg=#59899c guibg=#d6d4cf gui=bold
hi GitGutterChange ctermfg=162 ctermbg=241 cterm=bold guifg=#b778a0 guibg=#d6d4cf gui=bold
hi GitGutterDelete ctermfg=162 ctermbg=241 cterm=bold guifg=#b778a0 guibg=#d6d4cf gui=bold
hi makeCommands NONE
hi phpIdentifier NONE
hi phpFunctions NONE
hi phpClasses NONE
hi rustFuncCall ctermfg=111 guifg=#6b89b0
hi vimVar NONE
