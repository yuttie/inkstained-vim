...
hi SpecialKey ctermfg=188 ctermbg=66 cterm=bold guifg=#cbd7dc guibg=#4e8aa1 gui=bold
...
hi Number ctermfg=66 ctermbg=188 cterm=NONE guifg=#4e8aa1 guibg=#cbd7dc gui=NONE
...
hi IncSearch ctermfg=254 ctermbg=66 cterm=bold guifg=#e7e5e2 guibg=#4e8aa1 gui=bold
...
hi DiffAdd ctermfg=66 ctermbg=188 cterm=bold guifg=#4e8aa1 guibg=#cbd7dc gui=bold
hi DiffChange ctermfg=175 ctermbg=188 cterm=NONE guifg=#b0789b guibg=#d9d3d6 gui=NONE
hi DiffDelete ctermfg=175 ctermbg=188 cterm=NONE guifg=#b0789b guibg=#d9d3d6 gui=NONE
hi DiffText ctermfg=132 ctermbg=188 cterm=bold guifg=#a05b89 guibg=#d9d3d6 gui=bold
hi diffAdded ctermfg=66 ctermbg=188 cterm=NONE guifg=#4e8aa1 guibg=#cbd7dc gui=NONE
hi diffRemoved ctermfg=175 ctermbg=188 cterm=NONE guifg=#b0789b guibg=#d9d3d6 gui=NONE
...
hi GitGutterAdd ctermfg=66 ctermbg=188 cterm=bold guifg=#4e8aa1 guibg=#dfddd7 gui=bold
hi GitGutterChange ctermfg=175 ctermbg=188 cterm=bold guifg=#b0789b guibg=#dfddd7 gui=bold
hi GitGutterDelete ctermfg=175 ctermbg=188 cterm=bold guifg=#b0789b guibg=#dfddd7 gui=bold
